...
// Fix for deprecated and unavailable dependencies
replace github.com/mitchellh/osext => golang.org/x/sys v0.0.0-20191026070338-33540a1f6037

replace github.com/gin-contrib/cors => github.com/gin-contrib/cors v1.3.1

replace github.com/gin-gonic/gin => github.com/gin-gonic/gin v1.7.7

replace github.com/firecracker-microvm/firecracker-go-sdk => github.com/firecracker-microvm/firecracker-go-sdk v0.22.0
