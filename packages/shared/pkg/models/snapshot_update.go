...
func (su *SnapshotUpdate) ClearOriginNodeID() *SnapshotUpdate {
	su.mutation.ClearOriginNodeID()
	return su
}
...
func (su *SnapshotUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if su.mutation.OriginNodeIDCleared() {
		_spec.ClearField(snapshot.FieldOriginNodeID, field.TypeString)
	}
...
// ClearOriginNodeID clears the value of the "origin_node_id" field.
func (suo *SnapshotUpdateOne) ClearOriginNodeID() *SnapshotUpdateOne {
	suo.mutation.ClearOriginNodeID()
	return suo
}
...
func (suo *SnapshotUpdateOne) sqlSave(ctx context.Context) (_node *Snapshot, err error) {
	...
	if suo.mutation.OriginNodeIDCleared() {
		_spec.ClearField(snapshot.FieldOriginNodeID, field.TypeString)
	}
