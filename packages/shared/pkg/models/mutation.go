...
// ClearOriginNodeID clears the value of the "origin_node_id" field.
func (m *SnapshotMutation) ClearOriginNodeID() {
	m.origin_node_id = nil
	m.clearedFields[snapshot.FieldOriginNodeID] = struct{}{}
}

// OriginNodeIDCleared returns if the "origin_node_id" field was cleared in this mutation.
func (m *SnapshotMutation) OriginNodeIDCleared() bool {
	_, ok := m.clearedFields[snapshot.FieldOriginNodeID]
	return ok
}
...
func (m *SnapshotMutation) ResetOriginNodeID() {
	m.origin_node_id = nil
	delete(m.clearedFields, snapshot.FieldOriginNodeID)
}
...
func (m *SnapshotMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(snapshot.FieldOriginNodeID) {
		fields = append(fields, snapshot.FieldOriginNodeID)
	}
	return fields
}
