...
// OriginNodeIDIsNil applies the IsNil predicate on the "origin_node_id" field.
func OriginNodeIDIsNil() predicate.Snapshot {
	return predicate.Snapshot(sql.FieldIsNull(FieldOriginNodeID))
}

// OriginNodeIDNotNil applies the NotNil predicate on the "origin_node_id" field.
func OriginNodeIDNotNil() predicate.Snapshot {
	return predicate.Snapshot(sql.FieldNotNull(FieldOriginNodeID))
}
